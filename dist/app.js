...
var $author$project$Data$RISC$Parser$parseArgument = function () {
	...
	var parseHex = A2(
		...
		$elm$parser$Parser$getChompedString(
			$elm$parser$Parser$chompWhile($elm$core$Char$isHexDigit)));
	var parseNum = $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				A2(
				$elm$parser$Parser$keeper,
...
var $author$project$Main$init = function (flags) {
	...
	var parseProgram = _Utils_eq(arch, $author$project$Data$Assembly$RISC) ? $author$project$Data$RISC$Parser$parseProgram : $author$project$Data$CISC$Parser$parseProgram;
	return _Utils_Tuple2(
		_Utils_update(
			defaultModel,
			{
